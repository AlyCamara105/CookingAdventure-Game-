...
for index, TableValue in ipairs(RadialMenuComponents) do

    for index, gui in ipairs(RadialMenuScreenGui:GetChildren()) do -- Edits the dictionary for the gui with the info, connects events, and places GUI
...
UIS.InputBegan:Connect(function(input, gpe)
    ...
    elseif openedMenu then
        ...
        if input.UserInputType == Enum.UserInputType.Keyboard and input.KeyCode == Enum.KeyCode.R then
            ...
            for i = #RadialMenuComponents, 1, -1 do -- Calls the function to tween all gui

                TweenGuiEnd(RadialMenuComponents[i][2], TweenTime, delayTime, RadialMenuScreenGui.Center.Position)
        ...
        if input.UserInputType == Enum.UserInputType.Keyboard and input.KeyCode == Enum.KeyCode.R then
            ...
            for index, Table in ipairs(RadialMenuComponents) do -- Calls the function to tween all gui
