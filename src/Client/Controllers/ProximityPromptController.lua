...
function ProximityPromptController:Start()
    ...
    local function onLoad()
        ...
        ProximityPromptService.PromptShown:Connect(function(prompt, inputType)
            ...
            local cleanupFunction, promptUI = createPrompt(prompt, inputType, gui)
            
            promptUI.MaxDistance = 10
            --[[promptUI.Size = UDim2.fromScale(4,1.7)
            promptUI.Frame.ClipsDescendants = true
            promptUI.Frame.InputFrame.Frame.RoundFrame.Size = UDim2.fromScale(0.6,0.6)
            promptUI.Frame.InputFrame.Frame.ButtonImage.Size = UDim2.fromScale(0.4,0.4)]]
...
function ProximityPromptController:Init()
